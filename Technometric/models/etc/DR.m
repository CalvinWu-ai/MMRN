function [WX,W,auxmtx] = DRv2(Yaux,X,morph,dim,varargin)
...
% USAGE:
%   - outputs:
%     WX: linear combinations of the generating vectors of the data
%     subspace.
%     W: generating vectors of the reduced subspace.
%   - inputs:
%     Y: response vector.
%     X: predictors matrix.
